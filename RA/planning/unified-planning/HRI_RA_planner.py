...
def plan(garbage_type, bins_fullness, random_doors):
	...
	if garbage_type == "plastic":
		...
		problem.set_initial_value(level(bin1), bins_fullness[states2coords_bins["C9"]])
		problem.set_initial_value(level(bin2), bins_fullness[states2coords_bins["E39"]])
		problem.set_initial_value(level(bin3), bins_fullness[states2coords_bins["H12"]])
		...
		problem.set_initial_value(level(bin1), bins_fullness[states2coords_bins["D22"]])
		problem.set_initial_value(level(bin2), bins_fullness[states2coords_bins["E38"]])
		problem.set_initial_value(level(bin3), bins_fullness[states2coords_bins["G12"]])
		...
		problem.set_initial_value(level(bin1), bins_fullness[states2coords_bins["A1"]])
		problem.set_initial_value(level(bin2), bins_fullness[states2coords_bins["B30"]])
		problem.set_initial_value(level(bin3), bins_fullness[states2coords_bins["F18"]])
		...
		problem.set_initial_value(level(bin1), bins_fullness[states2coords_bins["I85"]])
		problem.set_initial_value(level(bin2), bins_fullness[states2coords_bins["I3"]])
	else:
		print(f"no garbage type named {garbage_type}!!!")
		return
	
	# for 'adj' fluents was a bit more tricky and time-consuming...
	f = open("../PDDL/adj_fluents.txt", "r")
	l = (f.read()).split(")")
